...
# Función matemática de tu código para leer la rotación del Excel
...
def main():
    ...
    id_cloud = 1
    # Bucle infinito que se detiene automáticamente cuando no hay más fotos
    while True:
        ...
        if odom_absoluta is not None:
            # Ponemos los puntos exactamente donde dice el Excel (Posición Absoluta)
    ...
    # Filtro para limpiar ruido y guardar
